...
public final class LootBoxConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_IRONS_SPELLBOOKS_REWARDS;
    public static final ForgeConfigSpec.BooleanValue ENABLE_GOETY_REWARDS;
    public static final ForgeConfigSpec.BooleanValue ENABLE_AE2_REWARDS;
    public static final ForgeConfigSpec.BooleanValue ENABLE_TERRA_ENTITY_REWARDS;
    public static final ForgeConfigSpec.BooleanValue ENABLE_TWILIGHT_FOREST_REWARDS;
    public static final ForgeConfigSpec.BooleanValue ENABLE_AETHER_REWARDS;
    ...
    private static ForgeConfigSpec.BooleanValue integration(ForgeConfigSpec.Builder builder, String modId,
